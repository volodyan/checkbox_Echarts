...
export default {
    ...
    /* ************ */
    /**--demo--***/
    // 'POST /api/PipeNetWorkDiagonseAvgChartData': (req, res) => {
    //     const {
    //         password,
    //         username
    //     } = req.body;
    //     return res.json(PipeNetWorkDiagonseAvgChartData);
    // },
    // 'POST /api/PipeNetWorkDiagonseRealChartData': (req, res) => {
    //     const {
    //         password,
    //         username
    //     } = req.body;
    //     return res.json(PipeNetWorkDiagonseRealChartData);
    // },
