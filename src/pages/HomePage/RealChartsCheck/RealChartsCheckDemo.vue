...
export default {
  ...
  mounted() {
    Bus.$on("ConTrolLegendFun_RealChartsCheck", (e) => {
      ...
      e.map((ele) => {
        LegendSelectedLists[ele] = true;
      });
      console.log("LegendSelectedLists", LegendSelectedLists);
      (this.chartData.LegendSelectedLists = LegendSelectedLists),
        this.setOptions(this.chartData);
    });
    Bus.$on("PipeNetWorkDiagonseAvgChartDataTo", (e) => {
      let colorList = [
        "#FFA500",
        "#7fbe9e",
        "#6495ED",
      ...
      if (!!e.DownLevelData.length) {
        e.DownLevelData.map((ele) => {
          ...
          JingDiData.push(0.3);
          GroundData.push(0.65);
          ManPipeData.push(1.3);
        });
      }
      ...
      this.chart.setOption({
        ...
        series: [
          ...
          },
          {
            ...
            xAxisIndex: 1,
            yAxisIndex: 1,
            data: chartData.ManPipeData,
            smooth: true,
            showSymbol: false,
            lineStyle: {
              width: 1,
              color: chartData.colorList[4],
            },
            itemStyle: {
              color: chartData.colorList[4],
            },
